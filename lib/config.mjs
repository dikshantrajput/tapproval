...
export const DEFAULTS = {
  ...
  // reading. Thirty seconds is comfortably longer than answering at the keyboard
  // takes and a small fraction of the wait it delays. Set 0 to notify immediately.
  graceSec: 30,
